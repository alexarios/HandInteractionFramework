...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected virtual void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            {
                Vector3 relPos = m_grabbedObj.transform.position - m_parentTransform.position;
                relPos = Quaternion.Inverse(m_parentTransform.rotation) * relPos;
            ...
            {
                Quaternion relOri = Quaternion.Inverse(m_parentTransform.rotation) * m_grabbedObj.transform.rotation;
    ...
    protected virtual void GrabEnd()
    {
        if (m_grabbedObj != null)
        {
			...
			OVRPose trackingSpace = m_parentTransform.ToOVRPose() * localPose.Inverse();
